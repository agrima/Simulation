/* fixing ITAM0=10 while vary ITAM1 from 11~20
*/
...
void sim()				/*1st process - named sim */
{
	...
	printf("\r\nITAM1 vs. average # of type0 jobs");
	...
	printf("\r\n\r\n ITAM1 vs. average # of type1 jobs");
	...
	printf("\r\n\r\n ITAM1 vs. average time spent in system by");
